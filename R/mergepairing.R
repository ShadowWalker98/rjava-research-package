...
#' )
#'
#' mergepairing(vertex_indices, vertex_values, edges_from, edges_to)
#'
#' @export
mergepairing <- function(vertex_indices, vertex_values, edges_from, edges_to) {
  ...
  .jcall(
    jhw, "V", "mainR",
    vertex_indices_java, vertex_values_java, edges_from_java, edges_to_java
  )
  ...
  class(res) <- c("reeb_pairs", class(res))
